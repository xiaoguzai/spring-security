...
public class LoginController {
    ...
    /***
     * 认证失败：被封装成AuthenticationException然后调用AuthenticationEntryPoint进行异常处理
     * 授权失败：封装成AccessDeniedException然后调用AccessDeniedHandler进行异常处理
     * AuthenticationEntryPoint和AccessDeniedHandler都是接口，我们可以创建实现类
     * 然后放到ResponseResult即可
     */
